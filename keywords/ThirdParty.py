...
########################################################################
    ...
    def cli_arista_add_portchannel_active(self, node, pc_number, pc_list, pc_priority=15000, pc_timeout=5):
        ...
        try:
            ...
            for x in port_list:
                ...
                switch.config(cli_input_2)
                cli_input_3 = "channel-group " + str(pc_number) + " mode active"
    ...
    def cli_arista_delete_portchannel_active(self, node, pc_number, pc_list):
        '''Configure Port Channel
