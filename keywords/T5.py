...
class T5(object):
    ...
    def rest_clear_fabric_interface_stats(self):
        ...
        t = test.Test()
        c = t.controller('master')
        url = '/api/v1/data/controller/applications/bcf/info/stats/interface/stats'
        c.rest.delete(url, {})
    ...
    def rest_verify_fabric_interface_rx_stats(self, switch, intf, frame_cnt, vrange=5):
        ...
        t = test.Test()
        c = t.controller('master')
        url = '/api/v1/data/controller/applications/bcf/info/stats/interface/stats[switch-name="%s"]/interface[name="%s"]' % (switch, intf)
        frame_cnt = int(frame_cnt)
        vrange = int(vrange)
        c.rest.get(url)
        data = c.rest.content()
